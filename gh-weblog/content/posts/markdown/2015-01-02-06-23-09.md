...
Open your blog in the browser by going to http://YourUserName.github.io/gh-blog (with, obviously, your username substituted), and click the "admin" link. This will pop up a dialog that you will have to fill in. For "username", fill in your github user name. For "repository", fill in "gh-blog". For "branch", fill in "gh-pages", and for