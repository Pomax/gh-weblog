...
# 2: Edit `index.html` to match your username and repository
...
# 3: Getting credentials so that you can edit/modify/delete posts directly
...
# 4: Authenticating yourself so you can use your new blog
